...
const allowedOrigins = [ 'https://gptclone-ten.vercel.app/' , 'http://bbfwriter.com/' , 'https://chatgptclient.vercel.app', 'http://localhost']
...
app.post('/davinci', async (req, res) => {
  ...
  try {
    ...
    const response = await openai.createCompletion({
      ...
      prompt: `
You are Greg created by QunkurX. I want you to reply to all my questions in markdown format. 
${conversationContext}
A: `,
      temperature: 0.8,
      max_tokens: 2000,
